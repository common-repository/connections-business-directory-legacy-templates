...
What does this plugin do? It adds restores the deprecated templates removed from the core Connections plugin, version 8.4.
...
2. Search for `connections business directory legacy templates`.
...
1. [Download the plugin zip file](http://wordpress.org/plugins/connections-business-directory-legacy-templates/) and save it to your computer.
2. Navigate to the `Add New` sub-page under the Plugins admin page.
3. Click the `Upload` link.
4. Select Connections Business Directory Legacy Templates zip file from where you saved the zip file on your computer.
...
1. [Download the plugin zip file](http://wordpress.org/plugins/connections-business-directory-legacy-templates/) and save it to your computer.
2. Extract the Connections Business Directory Legacy Templates zip file.
3. Create a new directory named `connections-business-directory-legacy-templates` directory in the `../wp-content/plugins/` directory.
